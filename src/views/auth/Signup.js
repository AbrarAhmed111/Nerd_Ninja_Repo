...
const Signup = () => {
    ...
    return (
        <Container className=' text-white min-h-screen'>
            <Row>
                <Col>
                    <img src={logo} alt='Logo' className=' mx-auto  w-[215px]' />
​
                    <Form className='mx-auto form-width text-start'> {/* Remove 'mx-auto text-center' classes */}
                        <IoArrowBackCircleOutline size={30} className='d-block cursor-pointer' onClick={handleGoBack}/>
                        <h1 className='text-center text-[40px] font-bold mb-[20px]'>Signup</h1>
...
​
                        <div className='mx-auto text-center'>
                            <Link to='/login'><Button className='py-2 mb-5 btn w-75 font-bold text-xl rounded-lg' color='primary' >Finish Signup &gt;&gt;</Button></Link>
                        </div>
​
                    </Form>
                </Col>

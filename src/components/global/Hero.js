...
const Hero = () => {
  return (
    <Container className='flex flex-col items-center justify-center py-0 lg:flex-row lg:py-10 xl:py-36  gap-y-5 xl:gap-y-0 lg:gap-x-20 my-10'>
      ...
      <Col className='flex flex-col items-start justify-center w-full py-4 lg:w-auto'>
        <h1 className='text-5xl font-bold lg:text-6xl'>Learn 3x Faster</h1>
